    ...
    <html lang="en">
      <body className={`${manrope.variable} font-sans antialiased`}>
        <WhistleProviderShell>
          <div className="mx-auto max-w-lg min-h-screen border-x border-[var(--fb-border)]">
            <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-[var(--fb-border)]">
          ...
          <nav className="fixed bottom-0 left-0 right-0 z-10 bg-white/90 backdrop-blur-md border-t border-[var(--fb-border)] lg:hidden">
